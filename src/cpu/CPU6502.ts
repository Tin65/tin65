import {
  ...
  import { cpuOperations } from "./cpuOperations.ts";
  ...
  export class CPU6502 {
    ...
    // internal CPU state
    // 3 primary registers
    public reg_a = 0; // accumulator (8 bit)
    public reg_x = 0; // x index register (8 bit)
    public reg_y = 0; // y index register (8 bit)
  
    // internal registers
    public programCounter = 0; // (16 bit)
    public stackPointer = 0x55; // (8 bit, implicit stack page 0001)
    public processorStatus = ProcessorStatus.const; // (8 bit)
    ...
    private executeNextInstruction() {
      ...
      for (let i = 0; i < this.instructionsPerEventLoopBreathe; i++) {
        ...
        instruction.func(this, instructionParam as number);
